...
例えば、[JavaScript Map](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Global_Objects/Map) インスタンスを SWR のキャッシュプロバイダーとして直接使用できます。
